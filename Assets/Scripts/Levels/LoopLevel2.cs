...
public class LoopLevel2: MonoBehaviour {
	...
	public float minTimeBetweenBomb = 5f, maxTimeBetweenBomb = 10f;
	public float minTimeBetweenLife = 10f, maxTimeBetweenLife = 30f;
	...
	void Update () {
		if (GameManager.lives == 0 || GameManager.currentNumberDestroyedStones == 30) {
