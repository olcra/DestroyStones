...
public class MainLoop: MonoBehaviour {
	...
	public float minTimeBetweenStones = 5f, maxTimeBetweenStones = 7f;
	public float minTimeBetweenBomb = 10f, maxTimeBetweenBomb = 20f;
	public float minTimeBetweenLife = 5f, maxTimeBetweenLife = 10f;
	...
	void Update () {
		if (GameManager.lives == 0 || GameManager.currentNumberDestroyedStones == 20) {
